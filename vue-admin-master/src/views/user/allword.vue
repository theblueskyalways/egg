	...
	<section>
		...
		<el-col :span="24" class="toolbar" style="padding-bottom: 0px;">
			<el-form :inline="true" :model="filters">
				<el-form-item>
					<el-input v-model="filters.word" placeholder="单词/翻译 支持模糊查询"></el-input>
				</el-form-item>
                <el-form-item>
					<el-radio-group v-model="filters.type">
                        <el-radio :label="0">所有单词</el-radio>
		...
		<el-table :data="clubList" highlight-current-row v-loading="listLoading" @selection-change="selsChange" style="width: 100%;">
			...
			<el-table-column label="操作">
				<template scope="scope">
					<el-button v-if="!scope.row.isMy" type='primary' size="small" @click="opt( scope.row )">加入我的生词</el-button>
		...
		<!--新增界面-->
        <el-dialog title="新增生词" :visible.sync="addFormVisible" :close-on-click-modal="false">
			<el-form :model="addForm" label-width='auto' :rules="addFormRules" ref="addForm">
				<el-form-item label-width='auto' label="单词:" prop="word">
					<el-input v-model="addForm.word" auto-complete="off"></el-input>
				</el-form-item>
				<el-form-item label-width='auto' label="翻译和词性:">
...
<script>
	...
	import { getallwordList, optMyWord } from '../../api/api';
