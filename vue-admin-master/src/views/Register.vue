<template>
  <el-form :model="ruleForm2" :rules="rules2" ref="ruleForm2" label-position="left" label-width="0px" class="demo-ruleForm login-container">
    ...
    <el-form-item prop="checkPass">
      <el-input type="password" v-model="ruleForm2.checkPass" auto-complete="off" placeholder="重复密码"></el-input>
    </el-form-item>
      ...
      handleSubmit2(ev) {
        ...
        this.$refs.ruleForm2.validate((valid) => {
          if (valid) {
            ...
            adminRegister(loginParams).then(data => {
              this.logining = false;
              //NProgress.done();
              let { msg, code, user, url } = data;
              if (code !== 200) {
                this.$message({
                  message: msg,
                  type: 'error'
